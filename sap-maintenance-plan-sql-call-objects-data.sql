CREATE TABLE `sap_maintenance_plan_call_objects_data`
(
  ...
  `PlannedStartDate`                  varchar(80) DEFAULT NULL,
    ...
    CONSTRAINT `MaintenancePlanCallObjectsData_fk` FOREIGN KEY (`MaintenancePlan`) REFERENCES `sap_maintenance_plan_header_data` (`MaintenancePlan`)
) ENGINE = InnoDB
